...
if (isset($_POST['submit']) && $_POST['submit'] == 'Search') {
    ...
    // echo $page; exit;
    // echo $_SESSION['currentPage'];exit;
}elseif (isset($_GET['page']) && $_GET['page'] == 'search' && isset($_SESSION['search_cdr']) && $_SESSION['search_cdr'] != '') {
...
$sqlSelect = $sql . ' LIMIT '.$paginationStart.', '.$limit;
// echo $sqlSelect;
