...
if (isset($_POST["MemberID"]) && !empty(trim($_POST["MemberID"]))) {
    //Include config file
    require_once "config.php";

    try {
        //prepare a select statement
        $sql = "DELETE FROM memberdetails where MemberID = :MemberID";
    ...
    if (empty(trim($_GET["MemberID"]))) {
        // URL doesn't contain id parameter. Redirect to error page
        header("location: error.php");
        echo "Can not find the MemberID";
        exit();
    }
}
?>
...
<html lang="en">
    <head>
        ...
        <title>DCCI :: Member Delete</title>
        <!-- Web Fonts -->
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                        <div class="alert alert-danger fade-in">
                                            <input type="hidden" name="MemberID" value="<?php echo trim($_GET["MemberID"]); ?>" />
                                            <p>Are you sure you want to delete this record?</p>

                                            <input type="submit" value="Yes" class="btn btn-danger"/>
                                            <a href="membership_details_copy.php" class="btn btn-default" style="background-color: white;">No</a>
                                        </div>
                                    </form>
                                </div>        
                            </div>
