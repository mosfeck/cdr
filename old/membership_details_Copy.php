...
//                    if(inputVal.length){
//                        $.get("back-search.php", {term: inputVal}).done(function(data){
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                        <div class="search-box">
                                            <input type="text" id="search_text" class="form-control-static" placeholder="Search any data in member"/>
<!--                                            <input type="submit" class="btn btn-primary resultbtn" value="Search" data-toggle="tooltip" data-placement="top" title="Search all data from blank search box"/>-->
                                            
                                        </div>
                                </div>
                                <div class="col-md-5">
                                    
                                    <div class="page-header clearfix" id="mt30">
                                        <!--<h2 class="pull-left">Member Details</h2>-->
                                        <a href="membership_insert.php" class="btn btn-success pull-left">Add New Member</a>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="page-header clearfix">
                                        <!--<h2 class="pull-left">Member Details</h2>-->
                                        <a href="membership_reset.php" class="btn btn-success">Reset Password</a>
                                    </div>
                                </div>
